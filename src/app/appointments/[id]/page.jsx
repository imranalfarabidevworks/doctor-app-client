...
export default async function DoctorDetails({ params }) {
  ...
  try {
    ...
    if (!res.ok) return <div className="text-center py-20 text-white">Doctor not found</div>;
    ...
    return <div className="text-center py-20 text-white">Something went wrong.</div>;
  }
}